...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24-Maio-2020 às 22:58
...
CREATE TABLE `formulario` (
  ...
  `cpf_formulario` int(15) DEFAULT NULL,
  ...
  `telefone_formulario` int(15) DEFAULT NULL,
...
--
ALTER TABLE `consultor`
  MODIFY `id_consultor` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `formulario`
--
ALTER TABLE `formulario`
  MODIFY `id_formulario` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `questionario`
--
ALTER TABLE `questionario`
  MODIFY `id_questionario` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
